  ...
  <div class="space-y-6">
    <div>
      ...
      <div class="space-y-4">
        <div class="flex items-center gap-4">
          <label class="text-sm font-medium min-w-[100px]"
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-4">
            <Slider
              ...
              class="flex-1"
            />
            <span class="text-sm min-w-[50px]"
              >{{ shadowStore.background.opacity }}%</span
            >
          </div>
        </div>
      </div>
    ...
    <div>
      ...
      <div class="text-sm text-muted-foreground">
        Adjust the background color and opacity to better visualize your shadows
    ...
    <div>
      ...
      <div class="text-sm text-muted-foreground space-y-2">
        <p>
          This CSS box-shadow generator allows you to create multiple shadow
          layers and preview them in real-time.
        </p>
        <p>Built with Vue 3, Nuxt 3, and Tailwind CSS V4.</p>
        <p>
          Use the presets for quick Material Design or Tailwind CSS shadows.
        </p>
      </div>
    </div>
  </div>
