<template>
  <div class="container px-0 mx-auto mb-10">
    <div class="prose">
      <h1
        class="h1 text-center mb-8 blue-grey--text text--darken-4"
        style="font-size: 3rem"
      >
        CSS Box-Shadow Generator
      </h1>
      <p class="text-h4 blue-grey--text text--darken-3">
...
export default {
  ...
  data() {
    return {
      ...
      structuredData: {
        ...
        sameAs: ['https://github.com/jcz530/shadows'],
  ...
  computed: {
    ...
    bgColor() {
      return `background: ${hexToRgba(
        this.$store.state.settings.bg.color,
        this.$store.state.settings.bg.opacity
      )}`
    },
  },
  methods: {},
